...
/**
 * This class is an iterator that moves through tweets in reverse chronological order.
 */
public class ChronoTwiterator implements Iterator<Tweet> {
   ...
   * @return the next tweet in the iteration if one exists, and advances next to the next
